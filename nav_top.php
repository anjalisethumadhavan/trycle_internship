...
<i class="fa fa-bell-o"></i>
                <span class="badge bg-warning"><?=($r[0]);?></span>
            </a>
	...
	?>
                <li>
                    <div class="alert alert-success clearfix">
					  ...
					  <div class="noti-info">
                            <a href="#"> Your remaining Amount is <?=$r1['ramain']?>/- <a>
							<a>And Due date is <?=$r1['due_date']?></a>
                        </div>
                    </div>
                </li>
<?php
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
				...
				<?php
				$t=select("select name from register where id='".$_SESSION['userid']."' ");
