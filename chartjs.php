...
<section class="wrapper">
		<div class="chart_agile">
			<div class="col-md-12 chart_agile_left">
				...
				<a href="date.php"><button class="btn btn-warning"> Date-wise chart
				</button ></a>
				<a href="month.php"><button class="btn btn-warning"> Month-wise chart
				</button ></a>
				<a href="yaer.php"><button class="btn btn-warning"> Year-wise chart
				</button ></a>
                    ...
                    <div class="panel-body">
						...
						<center>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="dateone" id="exampleInputEmail2" >
                            </div><br><br>
                         &nbsp; &nbsp;   <div class="form-group">
                                <label>To date:</label>
                                <input type="date" class="form-control" name="datetwo" id="exampleInputPassword2" >
                            </div>
                            <br> 
							<br> 
							<center>
