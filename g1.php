...
$one=$_REQUEST['dateone'];
$two=$_REQUEST['datetwo'];

if($stmt = $connection->query("SELECT catid,amount FROM expence where date BETWEEN '$one' AND '$two' and userid='".$_SESSION['userid']."'")){
