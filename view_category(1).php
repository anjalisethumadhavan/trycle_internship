...
<!DOCTYPE html>
<head>
<title>BUDGET MANAGEMENT SYSTEM | View Category</title>
      ...
      <table class="table" ui-jq="footable" ui-options='{
		...
		?>
          <tr data-expanded="true">
            ...
            <td><a href="edit_category.php?id=<?=$r[0]?>"><button class="btn btn-success">Edit</button></td>
            <td><a href="delete_category.php?id=<?=$r[0]?>"><button class="btn btn-danger">Delete</button></td>
