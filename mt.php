...
if($stmt = $connection->query("SELECT monthname(date),sum(amount) FROM expence where (date BETWEEN '$one' AND '$two' and userid='".$_SESSION['userid']."')GROUP BY month(date),year(date)")){
