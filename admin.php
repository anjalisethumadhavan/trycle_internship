...
if(isset($_REQUEST["submitmarks"]))
{
    ...
    $sql  = "update t_usermark set s_omr=";
    $sql .= "'" . $txtomr . "'";
    $sql .= "where s_id='" . $markof . "'";
    mysqli_query($con, $sql);
...
<form id="admin" action="admin.php" method="post">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <img src="images/cutm.jpg" width="100%" style="box-shadow: 0px 5px 5px #999999; ">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <ul class="nav nav-tabs" >
            ...
            <li><a data-toggle="tab" href="#admarks">Result Upload</a></li>
            <!--                        <li><a data-toggle="tab" href="#adadmin">Add New Manager</a></li>-->
            <li><a  href="exportdetails">Registration List</a></li>
            ...
            <div id="viewapp" class="tab-pane fade in active">
                ...
                while($ar = mysqli_fetch_array($rs1))
                {
                    ...
                    echo "<td> <a href='adminac.php?id=".$ar[0]."'>
                     <input type='button' value='Generate AdmitCard' name='adcard' class='toggle btn btn-primary'> </a></td>";
     ...
     <button class='add_field_button'  style='background-color:transparent;border:none;'
                   name='appr' id='appr' >
  <a href='adminac.php?id=".$ar[0]."'>
<!--                     <input type='button' value='Generate AdmitCard' name='adcard' class='toggle btn btn-primary'> </a>

<!--           <img src='./images/Tick.png' width='20px'>-->
                 </button> </a> </td>";
                    echo "<td>
<input type='button' class='toggle btn btn-primary' value='Accept' onclick='return change(this);'>
</td>";
...
<!--                     <img src='./images/cross.png' width='20px'>-->
                    ...
                    echo "<td> <input type='button' onclick='return changing(this)' class='toggle btn btn-primary'  id='disapp' value='Reject'  name='disapp''>
                    </td>";
                    echo "</tr>";
...
//               echo "</tr>";
            ...
            <!--            <input type="button" value="Open Curtain" onclick="" />-->
                                ...
                                <center> <div class="jumbotron" style="width:50%; box-shadow: -3px 3px 10px #999999;   margin-top:10px;">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="txtomr" id="showomr" placeholder="Sem" class="form-control" style="width:200px;"/>
                                                <input type="text" name="txtmark" id="txtmark" placeholder="Status" class="form-control" style="width:200px;"/>
                                            </div>
                                        </div><br>
                                ...
                                <center> <div class="jumbotron" style="width:50%; box-shadow: -3px 3px 10px #999999;   margin-top:10px;">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="markof" id="s_id" class="form-control" placeholder="Student ID" style="width:200px;"/>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="showomr"  id="showomr" placeholder="Sem " class="form-control" style="width:200px;"/><br>
                                                <input type="text" name="txtmark" id="txtmark" placeholder="Status" class="form-control" style="width:200px;"/>

                                            </div>
                                        </div><br>
                                        <input type="submit" value="Upload Result" name="submitmarks" id="submitmarks" class="toggle btn btn-primary"  />
                                    </div></center>
                            </div>
                        </div>
                    </div>
