...
<section id="main-content">
	...
	<section class="wrapper">
		<div class="chart_agile">
			<div class="col-md-10 chart_agile_left">
				<div class="chart_agile_top">
				<a href="chartjs.php"><button class="btn btn-warning">View Another Graph
				</button ></a>
...
$one=$_REQUEST['fromdate'];
$two=$_REQUEST['todate'];

if($stmt = $connection->query("SELECT date,sum(amount) FROM expence where (date BETWEEN '$one' AND '$two' and userid='".$_SESSION['userid']."')GROUP BY date")){
